...
//                 margin: EdgeInsets.only(left: 350, top: 0, right: 0, bottom: 0),
//                 child: Builder(
...
//                       _showSnackBar(
//                           context,
//                           "The menu is ${isOpen ? "open" : "closed"}",
//                           "${_buttonId}");
//                     },
//                     children: <Widget>[
...
//                       FloatingActionButton(
//                         onPressed: () {
//                           _showSnackBar(context, "You pressed 6",
//                               "With button ID: ${_buttonId}");
//                         },
//                         shape: CircleBorder(),
...
//                       FloatingActionButton(
//                         onPressed: () {
//                           _showSnackBar(context, "You pressed 7",
//                               "With button ID: ${_buttonId}");
//                         },
//                         shape: CircleBorder(),
...
//                       FloatingActionButton(
//                         onPressed: () {
//                           _showSnackBar(context, "You pressed 8",
//                               "With button ID: ${_buttonId}");
//                         },
//                         shape: CircleBorder(),
    ...
    return SideMenu(
      ...
      child: SideMenu(
        ...
        child: Scaffold(
          ...
          floatingActionButton: Container(
            margin: EdgeInsets.only(left: 310, top: 0, right: 0, bottom: 0),
            child: Builder(
              builder: (context) => FabCircularMenu(
                key: fabKey,
                // Cannot be `Alignment.center`
                ...
                children: <Widget>[
                  Image.asset('assets/dashboardIcon/notification.png', height: 120, width: 120),
                  FloatingActionButton(
                    onPressed: () {
                      _showSnackBar(context, "You pressed 2",
                          "With button ID: ${_buttonId}");
